...
- [AJAX](#ajax)
  - [XML](#xml)
  - [HTTP](#http)
  - [一、Ajax 核心概述](#一ajax-核心概述)
    - [1.1 什么是 Ajax？](#11-什么是-ajax)
    - [1.2 Ajax 核心特点](#12-ajax-核心特点)
    - [1.3 同步 vs 异步](#13-同步-vs-异步)
    - [1.4 Ajax 应用场景](#14-ajax-应用场景)
  - [二、Ajax 工作原理](#二ajax-工作原理)
    - [2.1 完整执行流程](#21-完整执行流程)
    - [2.2 核心对象：XMLHttpRequest](#22-核心对象xmlhttprequest)
  - [三、原生 Ajax 完整语法](#三原生-ajax-完整语法)
    - [3.1 基础四步写法](#31-基础四步写法)
    - [3.2 核心属性详解](#32-核心属性详解)
      - [3.2.1 readyState 请求状态码](#321-readystate-请求状态码)
      - [3.2.2 status HTTP 状态码](#322-status-http-状态码)
      - [3.2.3 响应数据属性](#323-响应数据属性)
    - [3.3 GET 请求](#33-get-请求)
    - [3.4 POST 请求](#34-post-请求)
    - [3.5 POST 传递 JSON 格式数据](#35-post-传递-json-格式数据)
  - [四、Ajax 错误处理与状态监听](#四ajax-错误处理与状态监听)
    - [4.1 完整容错写法](#41-完整容错写法)
  - [五、jQuery Ajax 封装](#五jquery-ajax-封装)
    - [5.1 通用 $.ajax 方法](#51-通用-ajax-方法)
    - [5.2 简写方法](#52-简写方法)
  - [六、Fetch API（现代原生异步请求）](#六fetch-api现代原生异步请求)
    - [6.1 基础 GET 请求](#61-基础-get-请求)
    - [6.2 完整 POST 请求](#62-完整-post-请求)
  - [七、Ajax 跨域问题](#七ajax-跨域问题)
    - [7.1 什么是跨域](#71-什么是跨域)
    - [7.2 常见跨域场景](#72-常见跨域场景)
    - [7.3 主流跨域解决方案](#73-主流跨域解决方案)
      - [7.3.1 CORS 后端跨域（最常用、推荐）](#731-cors-后端跨域最常用推荐)
      - [7.3.2 JSONP 跨域（老方案，只支持 GET）](#732-jsonp-跨域老方案只支持-get)
      - [7.3.3 代理跨域（前端工程化）](#733-代理跨域前端工程化)
- [ES6](#es6)
  - [一、ES6 变量声明：let / const（彻底淘汰 var）](#一es6-变量声明let--const彻底淘汰-var)
    - [1.1 废弃 var的原因](#11-废弃-var的原因)
    - [1.2 let 与 const 核心特性](#12-let-与-const-核心特性)
    - [1.3 三大核心规则](#13-三大核心规则)
      - [1. 块级作用域](#1-块级作用域)
      - [2. 禁止重复声明](#2-禁止重复声明)
      - [3. 暂时性死区（无变量提升）](#3-暂时性死区无变量提升)
    - [1.4 const 重点](#14-const-重点)
  - [二、异步编程：回调地狱（需要 Promise的原因）](#二异步编程回调地狱需要-promise的原因)
    - [2.1 回调地狱的定义](#21-回调地狱的定义)
    - [2.2 缺点](#22-缺点)
  - [三、Promise 详解](#三promise-详解)
    - [3.1 Promise 是什么？](#31-promise-是什么)
    - [3.2 Promise 三种状态（不可逆）](#32-promise-三种状态不可逆)
    - [3.3 Promise 基础语法](#33-promise-基础语法)
    - [3.4 Promise 链式调用（解决回调地狱）](#34-promise-链式调用解决回调地狱)
    - [3.5 Promise 封装 Ajax](#35-promise-封装-ajax)
  - [四、终极异步方案：async / await（ES7 基于 Promise）](#四终极异步方案async--awaites7-基于-promise)
    - [4.1 核心作用](#41-核心作用)
    - [4.2 两个核心关键字](#42-两个核心关键字)
    - [4.3 基础语法](#43-基础语法)
    - [4.4 顺序执行多个接口](#44-顺序执行多个接口)
    - [4.5 错误处理](#45-错误处理)
  - [五、全套异步方案进化史](#五全套异步方案进化史)
